...
const navItems = [
  ...
  { icon: Calendar, label: 'Master Agenda', path: '/admin/appointments' },
  { icon: Users, label: 'User Roles', path: '/admin/staff' },
  { icon: Wrench, label: 'Service Manager', path: '/admin/services' },
  { icon: Database, label: 'CRM & Histórico', path: '/admin/crm' },
  { icon: Package, label: 'Inventário', path: '/admin/inventory' },
  { icon: DollarSign, label: 'Finanças', path: '/admin/financial' },
